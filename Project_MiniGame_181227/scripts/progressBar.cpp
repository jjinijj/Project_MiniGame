...
HRESULT progressBar::init(int x, int y, int width, int height)
{
	...
	_rcProgress = { x, y, width, height };

	//{
	//	wstring imgName = AppendInt(L"frontBar", width);
	//	wstring fileName = MakeImageName(L"hpBarTop");
	//	_topImgName = imgName;
	//	_progressBarTop = IMAGEMANAGER->addImage(imgName, fileName.c_str(), x, y, width, height, true, RGB(255, 0, 255));
	//}
	//
	//{
	//	wstring imgName = AppendInt(L"backBar", width);
	//	wstring fileName = MakeImageName(L"hpBarBottom");
